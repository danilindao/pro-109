...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		thumb_tip_x=int((landmarks[8].x)*width)
		...
		print("distancia entre dedos",distance)
		print("posição do mouse",mouse.position,"posição central dos dedos",center_x,center_y)
